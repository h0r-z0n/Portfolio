...
export default function AProposDeMoi(props) {
	...
	useEffect(() => {
		async function fetchGithubStats() {
			const response = await fetch("https://api.github.com/users/h0r-z0n");
					...
					<div className="right-view">
						<ScrollAnimation animateIn="fadeIn" animateOnce delay={200}>
							...
							<div className="tech-and-cv">
								...
								<ButtonCV href="https://drive.google.com/file/d/1TZR-DAVBu0P1_fOLerdSL2gw26esHZgC/view?usp=sharing" target="_blank" data-splitbee-event="Download CV">
									Download CV
								</ButtonCV>
							</div>
						</ScrollAnimation>
