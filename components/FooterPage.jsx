...
export default function FooterPage(props) {
	...
	async function getLastCommit() {
		const response = await fetch("https://api.github.com/repos/h0r-z0n/Portfolio/commits");
			...
			<div id="grid">
				...
				<ScrollAnimation animateIn="fadeIn" animateOnce delay={200}>
					<SectionFooterMenu>
						...
						<FooterTextExternalLink href="https://github.com/h0r-z0n" target="_blank">
							Self-Hosting
				...
				<ScrollAnimation animateIn="fadeIn" animateOnce delay={400}>
					<SectionFooterMenu>
						...
						<FooterTextExternalLink href="https://github.com/h0r-z0n/Portfolio" target="_blank">
							Github
						</FooterTextExternalLink>
					</SectionFooterMenu>
				</ScrollAnimation>
