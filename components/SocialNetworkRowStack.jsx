...
export default function SocialNetworkRowStack() {
	return (
		<SocialMediaContainer>
			...
			<ButtonSocialMediaIcon href="https://github.com/h0r-z0n" target="_blank">
				<Github />
			</ButtonSocialMediaIcon>

			<ButtonSocialMediaIcon href="mailto:kshitijraut360@gmail.com" target="_blank">
				<MailSend />
			</ButtonSocialMediaIcon>

			<ButtonSocialMediaIcon href="https://www.linkedin.com/in/kshitij-raut/	" target="_blank" data-splitbee-event="linkedin-access">
				<LinkedinSquare />
			</ButtonSocialMediaIcon>

			<ButtonSocialMediaIcon href=" https://twitter.com/H4ck_H0riz0n" target="_blank">
				<Twitter />
			</ButtonSocialMediaIcon>
