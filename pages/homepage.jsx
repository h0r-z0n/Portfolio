...
export default function HomePage() {
	...
	return (
		<SectionHomePage id="section-home">
			...
			<Head
				title="Kshitij Raut | Portfolio"
				metaDescription="Portfolio of Kshitij Raut, projects and skills"
				keywords="Kshitij Raut, Cyber Security, Programming, CSIR, Pentesting"
			/>
			<LandingPageContainer>

				<TitleLandingContainer>
					<SubTitleLanding>{language.landingPage.apresentationText}</SubTitleLanding>
					<Typed strings={["Kshitij Raut"]} typeSpeed={80} className="type-string " />
